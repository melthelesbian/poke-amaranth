...
; catch rate groups
DEF CR_CHALLENGING EQU  7
DEF CR_VERY_HARD   EQU  27
DEF CR_HARD        EQU  63
DEF CR_NORMAL      EQU  127
DEF CR_EASY        EQU  191
DEF CR_VERY_EASY   EQU  227
DEF CR_TRIVIAL     EQU  247

; exp yield 
DEF EXP_YIELD_VERY_LOW   EQU 27
DEF EXP_YIELD_LOW        EQU 63
DEF EXP_YIELD_NORMAL     EQU 127
DEF EXP_YIELD_HIGH       EQU 191
DEF EXP_YIELD_VERY_HIGH  EQU 227
