...
; Vermilion City events
	...
	const EVENT_DEFEATED_BUG_SANCTUARY
	const EVENT_BEAT_BUG_SANCTUARY_GEORGIA
	const EVENT_BEAT_BUG_SANCTUARY_BUGCATCHER_1
	const EVENT_BEAT_BUG_SANCTUARY_BUGCATCHER_2
	const EVENT_BEAT_BUG_SANCTUARY_LASS
	const EVENT_BEAT_BUG_SANCTUARY_JRTRAINER_F
	const EVENT_GOT_PINSIR
	const EVENT_GOT_SCYTHER
...
; Route 8 events
	...
	const EVENT_BEAT_ROUTE_8_TRAINER_9
...
; Route 14 events
	...
	const EVENT_BEAT_ROUTE_14_FAIRY_CAVE_TRAINER
