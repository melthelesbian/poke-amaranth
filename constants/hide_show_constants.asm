...
; and are detected in wMissableObjectList)
	...
	const HS_ROUTE_12_FOSSIL               ; [TODO) shift values
	const HS_ROUTE_14_FAIRY_CAVE_ITEM      ; [TODO) shift values more
	...
	const HS_MEDITATION_CAVE_ITEM          ; [TODO) shift values
	...
	const HS_ROCKET_HIDEOUT_B4F_ITEM_3     ; 86 X [TODO) shift values
	...
	const HS_BUG_SANCTUARY_GIFT_1          ; [TODO) fix references, everything below
	const HS_BUG_SANCTUARY_GIFT_2          ; [TODO) is wrong
