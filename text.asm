...
INCLUDE "text/Route12FishingGuruHouse.asm"
...
INCLUDE "text/CeruleanLesbianHouse.asm"
...
INCLUDE "text/CeruleanFishingHouse.asm"
...
INCLUDE "text/VermilionFishingGuruHouse.asm"
...
INCLUDE "text/FuchsiaFishingGuruHouse.asm"
...
INCLUDE "data/moves/names.gen.asm"
