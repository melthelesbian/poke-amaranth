TypeEffects:
	...
	; db GRASS,        STEEL,        NOT_VERY_EFFECTIVE ; - 1/2x STEEL (balance)
	...
	db ELECTRIC,     STEEL,        SUPER_EFFECTIVE    ; + 2x STEEL (balance)
    db ELECTRIC,     DRAGON,       NOT_VERY_EFFECTIVE

	; db ICE,          FIRE,         NOT_VERY_EFFECTIVE ; - 1/2x FIRE (gen 1 restoration)
	db ICE,          WATER,        SUPER_EFFECTIVE      ; - 1/2x WATER, + 2x WATER (balance)
	; db ICE,          GRASS,        SUPER_EFFECTIVE    ; - 2x GRASS (balance)
	...
	db POISON,       FIGHTING,     SUPER_EFFECTIVE    ; + 2x FIGHTING (balance)
	db POISON,       POISON,       NOT_VERY_EFFECTIVE
	db POISON,       GROUND,       NOT_VERY_EFFECTIVE
	db POISON,       BUG,          SUPER_EFFECTIVE    ; + 2x BUG (gen 1 restoration)
	...
	db GROUND,       GRASS,        NO_EFFECT       ; - 1/2x GRASS, + 0x GRASS (balance)
	...
	db BUG,          POISON,       SUPER_EFFECTIVE    ; - 1/2x POISON, + 2x POISON (gen 1 restoration)
