...
FisherData:
; SS Anne 2F Rooms
	db 17, GOLDEEN, TENTACOOL, SEAKING, 0
; SS Anne B1F Rooms
...
Green2Data:
; SS Anne 2F
	db $FF, 23, PIDGEOTTO, 19, RATICATE, 20, KADABRA, 24, WARTORTLE, 0
	db $FF, 23, PIDGEOTTO, 19, RATICATE, 20, KADABRA, 24, IVYSAUR, 0
	db $FF, 23, PIDGEOTTO, 19, RATICATE, 20, KADABRA, 24, CHARMELEON, 0
; Pokémon Tower 2F
