...
PalPacket_Titlescreen:    PAL_SET PAL_LOGO2, PAL_LOGO1, PAL_AMARANTH, PAL_PURPLEMON
PalPacket_TrainerCard:    PAL_SET PAL_AMARANTH, PAL_BADGE, PAL_REDMON, PAL_YELLOWMON
PalPacket_Generic:        PAL_SET PAL_AMARANTH, 0, 0, 0
