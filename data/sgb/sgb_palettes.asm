...
IF DEF(_AMARANTH)
	RGB 31,29,31, 30,30,17, 21,00,04, 12,00,16 ; PAL_LOGO1
ENDC
IF DEF(_RED)
...
ENDC
	...
	RGB 31,29,31, 24,15,29, 09,20,11, 03,02,02 ; PAL_GREENBAR
	RGB 31,29,31, 24,15,29, 26,20,00, 03,02,02 ; PAL_YELLOWBAR
	RGB 31,29,31, 24,15,29, 26,10,06, 03,02,02 ; PAL_REDBAR
