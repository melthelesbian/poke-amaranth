...
MapHeaderPointers::
	...
	dw Route14FairyCave_h ; ROUTE_14_FAIRY_CAVE
	dw Route15House_h ; ROUTE_15_HOUSE
	dw SilphCo2F_h
	dw SilphCo3F_h
	dw SilphCo4F_h
	dw SilphCo5F_h
	...
	dw CeruleanFishingHouse_h ; CERULEAN_FISHING_HOUSE
	dw RockTunnelB1F_h
	dw SilphCo9F_h
	dw SilphCo10F_h
	dw SilphCo11F_h
	dw SilphCoElevator_h
	dw MoveManiacHouse_h ; MOVE_MANIAC_HOUSE
