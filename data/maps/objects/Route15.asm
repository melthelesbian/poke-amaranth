	...
	const_export ROUTE15_TM_TWIN_SLICE
...
Route15_Object:
	...
	warp_event 35,  5, ROUTE_15_HOUSE, 1

	def_bg_events
	bg_event 45,  9, TEXT_ROUTE15_SIGN
	bg_event 37,  7, TEXT_ROUTE15_HOUSE_SIGN
	...
	object_event 29,  5, SPRITE_COOLTRAINER_F, STAY, RIGHT, TEXT_ROUTE15_COOLTRAINER_F3, OPP_JR_TRAINER_F, 22
	object_event 18, 13, SPRITE_COOLTRAINER_F, STAY, UP, TEXT_ROUTE15_COOLTRAINER_F4, OPP_JR_TRAINER_F, 23
	object_event 18,  5, SPRITE_POKE_BALL, STAY, NONE, TEXT_ROUTE15_TM_TWIN_SLICE, TM_TWIN_SLICE
