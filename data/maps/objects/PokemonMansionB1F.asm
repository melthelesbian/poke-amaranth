	...
	const_export POKEMONMANSIONB1F_TM_WATERFALL
	const_export POKEMONMANSIONB1F_TM_SOLARBEAM
	const_export POKEMONMANSIONB1F_DIARY
	const_export POKEMONMANSIONB1F_TM_ICE_BEAM
...
PokemonMansionB1F_Object:
	...
	object_event 19, 25, SPRITE_POKE_BALL, STAY, NONE, TEXT_POKEMONMANSIONB1F_TM_WATERFALL, TM_WATERFALL
	...
	object_event  5, 13, SPRITE_POKE_BALL, STAY, NONE, TEXT_POKEMONMANSIONB1F_TM_ICE_BEAM, TM_ICE_BEAM
