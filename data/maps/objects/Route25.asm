	...
	const_export ROUTE25_SWEETHEART
	const_export ROUTE25_TM_HEADBUTT
...
Route25_Object:
	...
	object_event 44, 10, SPRITE_FAIRY_GIRL, STAY, LEFT, TEXT_ROUTE25_SWEETHEART, OPP_SWEETHEART, 4
	object_event 22,  2, SPRITE_POKE_BALL, STAY, NONE, TEXT_ROUTE25_TM_HEADBUTT, TM_HEADBUTT
