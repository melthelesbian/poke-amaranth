...
VermilionCity_Object:
	...
	warp_event  7,  3, VERMILION_FISHING_GURU_HOUSE, 1
	warp_event 24,  3, BUG_SANCTUARY, 1

	def_bg_events
	bg_event 21,  9, TEXT_VERMILIONCITY_SIGN
	...
	bg_event 23,  5, TEXT_VERMILIONCITY_BUG_SANCTUARY_SIGN

	def_object_events
	object_event 19,  7, SPRITE_BEAUTY, WALK, LEFT_RIGHT, TEXT_VERMILIONCITY_BEAUTY
	object_event 15,  4, SPRITE_GAMBLER, STAY, NONE, TEXT_VERMILIONCITY_GAMBLER1
