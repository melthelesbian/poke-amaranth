...
FuchsiaCity_Object:
	...
	warp_event 15, 27, MOVE_MANIAC_HOUSE, 1
	...
	warp_event 31, 27, FUCHSIA_FISHING_GURU_HOUSE, 2
	warp_event 31, 24, FUCHSIA_FISHING_GURU_HOUSE, 1

	def_bg_events
	bg_event 21, 29, TEXT_FUCHSIACITY_SIGN1
