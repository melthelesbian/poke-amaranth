	...
	const_export SSANNE1FROOMS_TM_SUBSTITUTE
...
SSAnne1FRooms_Object:
	...
	object_event 12, 15, SPRITE_POKE_BALL, STAY, NONE, TEXT_SSANNE1FROOMS_TM_SUBSTITUTE, TM_SUBSTITUTE
	object_event 22, 11, SPRITE_NURSE, STAY, DOWN, TEXT_SSANNE1FROOMS_NURSE
