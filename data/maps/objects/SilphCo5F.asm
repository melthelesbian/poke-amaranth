	...
	const_export SILPHCO5F_TM_HEAVY_SMASH
...
SilphCo5F_Object:
	...
	object_event  2, 13, SPRITE_POKE_BALL, STAY, NONE, TEXT_SILPHCO5F_TM_HEAVY_SMASH, TM_HEAVY_SMASH
	object_event  4,  6, SPRITE_POKE_BALL, STAY, NONE, TEXT_SILPHCO5F_PROTEIN, PROTEIN
	object_event 21, 16, SPRITE_POKE_BALL, STAY, NONE, TEXT_SILPHCO5F_CARD_KEY
