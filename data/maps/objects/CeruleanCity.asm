	...
	const_export CERULEANCITY_GRANNY
...
CeruleanCity_Object:
	...
	warp_event 19, 25, CERULEAN_LESBIAN_HOUSE, 1
	...
	object_event 35, 12, SPRITE_COOLTRAINER_F, STAY, LEFT, TEXT_CERULEANCITY_COOLTRAINER_F3
