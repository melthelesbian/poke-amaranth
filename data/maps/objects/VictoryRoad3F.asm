	...
	const_export VICTORYROAD3F_SWEETHEART
	const_export VICTORYROAD3F_MAX_REVIVE
	const_export VICTORYROAD3F_TM_SHADOW_TEAR
...
VictoryRoad3F_Object:
	...
	object_event 14, 15, SPRITE_FAIRY_GIRL, STAY, RIGHT, TEXT_VICTORYROAD3F_SWEETHEART, OPP_SWEETHEART, 11
	object_event 26,  5, SPRITE_POKE_BALL, STAY, NONE, TEXT_VICTORYROAD3F_MAX_REVIVE, MAX_REVIVE
	object_event  7,  7, SPRITE_POKE_BALL, STAY, NONE, TEXT_VICTORYROAD3F_TM_SHADOW_TEAR, TM_SHADOW_TEAR
