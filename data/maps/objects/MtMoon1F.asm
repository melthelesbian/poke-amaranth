	...
	const_export MTMOON1F_FRESH_WATER1
	const_export MTMOON1F_MOON_STONE
	const_export MTMOON1F_RARE_CANDY
	const_export MTMOON1F_ESCAPE_ROPE
	const_export MTMOON1F_FRESH_WATER2
	const_export MTMOON1F_TM_DOUBLE_KICK
...
MtMoon1F_Object:
	...
	object_event  2, 20, SPRITE_POKE_BALL, STAY, NONE, TEXT_MTMOON1F_FRESH_WATER1, FRESH_WATER
	...
	object_event 20, 33, SPRITE_POKE_BALL, STAY, NONE, TEXT_MTMOON1F_FRESH_WATER2, FRESH_WATER
	object_event  5, 32, SPRITE_POKE_BALL, STAY, NONE, TEXT_MTMOON1F_TM_DOUBLE_KICK, TM_DOUBLE_KICK
