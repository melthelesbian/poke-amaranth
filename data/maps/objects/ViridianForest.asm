	...
	const_export VIRIDIANFOREST_SWEETHEART
	const_export VIRIDIANFOREST_PANACEA
	const_export VIRIDIANFOREST_FRESH_WATER
...
ViridianForest_Object:
	...
	bg_event 16, 32, TEXT_VIRIDIANFOREST_USE_PANACEA_SIGN
	...
	object_event 15, 16, SPRITE_FAIRY_GIRL, STAY, RIGHT, TEXT_VIRIDIANFOREST_SWEETHEART, OPP_SWEETHEART, 1
	object_event 25, 11, SPRITE_POKE_BALL, STAY, NONE, TEXT_VIRIDIANFOREST_PANACEA, PANACEA
	object_event 12, 29, SPRITE_POKE_BALL, STAY, NONE, TEXT_VIRIDIANFOREST_FRESH_WATER, FRESH_WATER
