MapSongBanks::
	...
	db MUSIC_ROUTES1, BANK(Music_Routes1) ; UNDERGROUND_CROSSROADS
	db MUSIC_CITIES2, BANK(Music_Cities2) ; CERULEAN_LESBIAN_HOUSE
	db MUSIC_DUNGEON3, BANK(Music_Dungeon3) ; MEDITATION_CAVE (UNUSED_MAP_6B)
	db MUSIC_DUNGEON3, BANK(Music_Dungeon3) ; VICTORY_ROAD_1F
	db MUSIC_DUNGEON2, BANK(Music_Dungeon2) ; BUG_SANCTUARY (UNUSED_MAP_6D)
	db MUSIC_DUNGEON3, BANK(Music_Dungeon3) ; MT_MOON_SQUARE (UNUSED_MAP_6E)
	db MUSIC_DUNGEON3, BANK(Music_Dungeon3) ; MT_MOON_SQUARE_GIFT_SHOP (UNUSED_MAP_6F)
	db MUSIC_CITIES2, BANK(Music_Cities2) ; SURF_HOUSE
	...
	db MUSIC_CITIES2, BANK(Music_Cities2) ; VERMILION_FISHING_GURU_HOUSE
	db MUSIC_CITIES2, BANK(Music_Cities2) ; FUCHSIA_FISHING_GURU_HOUSE
	...
	db MUSIC_CELADON, BANK(Music_Celadon) ; ROUTE_12_FISHING_GURU_HOUSE
	...
	db MUSIC_DUNGEON2, BANK(Music_Dungeon2) ; ROUTE_12_FOSSIL_CAVE
	db MUSIC_DUNGEON1, BANK(Music_Dungeon1) ; ROUTE_14_FAIRY_CAVE
	db MUSIC_CITIES1, BANK(Music_Cities1) ; ROUTE_15_HOUSE
	...
	db MUSIC_CITIES1, BANK(Music_Cities1) ; CERULEAN_FISHING_HOUSE
	...
	db MUSIC_CITIES2, BANK(Music_Cities2) ; MOVE_MANIAC_HOUSE
