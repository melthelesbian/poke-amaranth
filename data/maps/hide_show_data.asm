...
; entries correspond to map ids
	...
	dw NoHS
	dw MeditationCaveHS ; MeditationCaveHS
	dw VictoryRoad1FHS
	dw BugSanctuaryHS
	dw NoHS
	dw NoHS
...
Route4HS:
	db ROUTE_4, ROUTE4_TM_RAZOR_LEAF, SHOW
Route9HS:
...
Route15HS:
	db ROUTE_15, ROUTE15_TM_TWIN_SLICE, SHOW
Route16HS:
...
Route25HS:
	db ROUTE_25, ROUTE25_TM_HEADBUTT, SHOW
BluesHouseHS:
...
PokemonTower4FHS:
	...
	db POKEMON_TOWER_4F, POKEMONTOWER4F_PANACEA, SHOW
...
PokemonTower6FHS:
	...
	db POKEMON_TOWER_6F, POKEMONTOWER6F_REVIVE, SHOW
PokemonTower7FHS:
...
PowerPlantHS:
	...
	db POWER_PLANT, POWERPLANT_TM_AGILITY, SHOW
...
VictoryRoad2FHS:
	...
	db VICTORY_ROAD_2F, VICTORYROAD2F_PANACEA,     SHOW
	db VICTORY_ROAD_2F, VICTORYROAD2F_TM_MOONBLAST,  SHOW
	db VICTORY_ROAD_2F, VICTORYROAD2F_CALCIUM,    SHOW
...
MeditationCaveHS:
	db MEDITATION_CAVE, MEDITATIONCAVE_TM_HYPER_BEAM, SHOW
VictoryRoad3FHS:
	db VICTORY_ROAD_3F, VICTORYROAD3F_MAX_REVIVE,   SHOW
	db VICTORY_ROAD_3F, VICTORYROAD3F_TM_SHADOW_TEAR, SHOW
...
RocketHideoutB2FHS:
	...
	db ROCKET_HIDEOUT_B2F, ROCKETHIDEOUTB2F_TM_BUG_BUZZ, SHOW
	db ROCKET_HIDEOUT_B2F, ROCKETHIDEOUTB2F_SUPER_POTION,  SHOW
RocketHideoutB3FHS:
	db ROCKET_HIDEOUT_B3F, ROCKETHIDEOUTB3F_TM_FLARE_RUSH, SHOW
...
SilphCo4FHS:
	...
	db SILPH_CO_4F, SILPHCO4F_PANACEA,   SHOW
...
SilphCo5FHS:
	...
	db SILPH_CO_5F, SILPHCO5F_TM_HEAVY_SMASH, SHOW
...
SilphCo6FHS:
	...
	db SILPH_CO_6F, SILPHCO6F_PP_UP,      SHOW
SilphCo7FHS:
...
SilphCo10FHS:
	...
	db SILPH_CO_10F, SILPHCO10F_TM_VENOM_STRIKE,  SHOW
...
PokemonMansionB1FHS:
	...
	db POKEMON_MANSION_B1F, POKEMONMANSIONB1F_TM_WATERFALL,  SHOW
	db POKEMON_MANSION_B1F, POKEMONMANSIONB1F_TM_SOLARBEAM, SHOW
	db POKEMON_MANSION_B1F, POKEMONMANSIONB1F_TM_ICE_BEAM,   SHOW
SafariZoneEastHS:
	...
	db SAFARI_ZONE_EAST, SAFARIZONEEAST_TM_LIGHT_SCREEN,  SHOW
SafariZoneNorthHS:
...
SafariZoneWestHS:
	...
	db SAFARI_ZONE_WEST, SAFARIZONEWEST_TM_DRAGONBREATH, SHOW
...
VictoryRoad1FHS:
	db VICTORY_ROAD_1F, VICTORYROAD1F_TM_CRUNCH, SHOW
	db VICTORY_ROAD_1F, VICTORYROAD1F_RARE_CANDY,    SHOW
BugSanctuaryHS:
	db BUG_SANCTUARY, BUGSANCTUARY_PINSIR_POKE_BALL, SHOW
	db BUG_SANCTUARY, BUGSANCTUARY_SCYTHER_POKE_BALL, SHOW
ChampionsRoomHS:
