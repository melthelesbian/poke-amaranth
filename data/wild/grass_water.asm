WildDataPointers:
	...
	dw NothingWildMons
	dw NothingWildMons
	dw NothingWildMons ; UndergroundCrossroads
	dw NothingWildMons
	dw MeditationCaveWildMons ; MeditationCave
	dw VictoryRoad1FWildMons
	dw NothingWildMons
	dw MtMoonSquareWildMons ; MtMoonSquare
	dw NothingWildMons ; MtMoonSquareGiftShop
	dw NothingWildMons
	dw NothingWildMons
	dw NothingWildMons
	dw NothingWildMons
	...
	dw Route14FairyCaveWildMons ; Route 14 Fairy Cave
	dw NothingWildMons
	dw NothingWildMons
	dw NothingWildMons
	dw NothingWildMons
...
INCLUDE "data/wild/maps/Route14FairyCave.asm"
