KeyItemFlags:
	...
	dbit FALSE ; UNUSED_0B (ANTIDOTE)
	dbit FALSE ; UNUSED_0C (BURN_HEAL)
	dbit FALSE ; UNUSED_0D (ICE_HEAL)
	dbit FALSE ; UNUSED_0E (AWAKENING)
	dbit FALSE ; UNUSED_0F (PARLYZ_HEAL)
