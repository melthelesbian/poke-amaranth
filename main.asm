...
INCLUDE "engine/events/hidden_objects/cheap_candy.asm"
INCLUDE "engine/events/hidden_objects/vending_machine.asm"
...
INCLUDE "engine/pokemon/move_screen.asm"
...
INCLUDE "engine/pokemon/move_maniac.asm"
